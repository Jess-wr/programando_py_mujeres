...
function typeOfBooleanTrue() {
  let verdadera = true
  console.log(verdadera, typeof verdadera)
}
typeOfBooleanTrue()
...
//Escribe un programa que solicite al usuario que ingrese un número del 1 al 7 y muestre un mensaje en la consola indicando el día de la semana correspondiente.*"Los dias de la semana deben estas escritos de la siguiente manera Lunes, Martes, Miercoles..."
...
//Crea una función que reciba un número n y devuelva la suma de todos los números del 1 al n. Utiliza un bucle for para calcular la suma y muestra el resultado en la consola. *"debe imprimir solo el numero"
function sumaAcumulada(n) {}

//Crea una función que reciba un vector y devuelva la suma de todos sus elementos. Utiliza un bucle while para calcular la suma y muestra el resultado en la consola.*"debe imprimir solo el numero"
